...
| [014](014-keyboard-traps.md) | Facet filter options unreachable by keyboard (WCAG A) | - | **DONE** ([synthesis](arena/014-synthesis.md)) |
| [015](015-theme-never-applies-on-mount.md) | Dark class never applied on mount; first click is a no-op | - | **DONE** ([synthesis](arena/015-synthesis.md)) |
